		...
		<div class="col-md-4">
				<?php
				  if(@$_POST['masuk']){
					  ...
					  @$a=mysqli_query($connect,"SELECT * from tb_user where username='$username_login' AND password='$password_login' AND jenis_user='$akses' AND keterangan='1'") or die (mysqli_error($connect));
				...
				//echo $cek;
						...
						echo"
							...
							echo "Username / Password Salah".mysqli_error($connect);
						}
				}
				?>
		</div>
